...
class ReservationModel {
    ...
    /*  -----  NUEVO: creación detallada  ------------------------------ */
    public function createDetailed($userId, $flightId, array $detalle, $precio){
        ...
        $sql = 'INSERT INTO reservas (usuario_id, vuelo_id, codigo_reserva,
    ...
    public function create($userId,$flight){
        // … (igual que antes, para flujo antiguo) …
        $this->db->beginTransaction();
